  ...
  return (
    <div className="relative w-full min-h-[75vh] sm:min-h-[82vh] flex items-end pb-16 sm:pb-24">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-md-surface-dim via-transparent to-black/30" />
      </div>

      {/* Content */}
      <div className="relative z-10 px-8 md:px-16 max-w-2xl">
        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-md-primary-container text-md-on-primary-container text-[11px] font-black rounded-sm mb-5 uppercase tracking-widest">
        ...
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 text-sm font-semibold mb-5">
          <span className="text-md-secondary font-bold">{course.duration}</span>
          <span className="text-gray-600">•</span>
          <span className="text-gray-300">{course.modules} módulos</span>
          <span className="text-gray-600">•</span>
          <span className="flex items-center gap-1 text-md-tertiary font-bold">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="flex items-center gap-2.5 bg-md-primary text-md-on-primary font-black px-6 sm:px-8 py-3 rounded-md hover:bg-md-primary-container transition-colors text-sm whitespace-nowrap"
          >
            <Play size={18} fill="white" strokeWidth={0} /> Assistir Agora
          </Link>
          <Link
            href={`/player/${course.id}`}
